...
import { O as Outlet, d as useRouterState, L as Link, e as useNavigate } from "../_libs/tanstack__react-router.mjs";
import { u as useTheme, d as useLang, L as LANGUAGES } from "./router-Brv9oJny.mjs";
...
import { s as signOut } from "./auth-BTtvEmdt.mjs";
import { u as useQuery } from "../_libs/tanstack__react-query.mjs";
import { a as api } from "./api-DONQIbPy.mjs";
import { u as useTranslation } from "../_libs/react-i18next.mjs";
import { c as LayoutDashboard, u as CircleArrowDown, O as Link2, v as CircleArrowUp, Z as PiggyBank, _ as Briefcase, $ as Receipt, a0 as ChartCandlestick, a as Copy, a1 as Zap, R as Radio, U as Users, a2 as CircleUser, S as ShieldCheck, a3 as Lock, a4 as Settings, a5 as LifeBuoy, m as Wallet, a6 as Sun, a7 as Moon, a8 as Languages, a9 as Bell, h as LogOut, aa as PanelLeft, X, g as ChevronRight, p as Check, ab as Circle } from "../_libs/lucide-react.mjs";
...
const MAIN_ITEMS = [
  ...
  { to: "/dashboard/deposit", key: "dashboard.sidebar.deposit", icon: CircleArrowDown },
  { to: "/dashboard/link-wallet", key: "dashboard.sidebar.linkWallet", icon: Link2 },
  { to: "/dashboard/withdraw", key: "dashboard.sidebar.withdraw", icon: CircleArrowUp },
  ...
  { to: "/dashboard/trade-history", key: "dashboard.sidebar.tradeHistory", icon: ChartCandlestick },
  { to: "/dashboard/trade", key: "dashboard.sidebar.trade", icon: ChartCandlestick }
];
const TRADE_ITEMS = [
...
const ACCOUNT_ITEMS = [
  { to: "/dashboard/profile", key: "dashboard.sidebar.profile", icon: CircleUser },
...
function DashboardShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen w-full bg-secondary/40", children: [
...
function DashboardOutlet() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) });
}
function AppSidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "border-b border-sidebar-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex h-14 items-center ${collapsed ? "justify-center" : "px-2"}`, children: collapsed ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold text-sidebar-primary", children: "BP" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { light: true }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Group, { label: t("dashboard.sidebar.main"), items: MAIN_ITEMS, isActive }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Group, { label: t("dashboard.sidebar.trading"), items: TRADE_ITEMS, isActive }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Group, { label: t("dashboard.sidebar.account"), items: ACCOUNT_ITEMS, isActive })
    ] })
  ] });
}
function Group({ label, items, isActive }) {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: items.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: isActive(i.to, i.exact), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: i.to, className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(i.icon, { className: "h-4 w-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t(i.key) })
    ] }) }) }, i.to)) }) })
  ] });
}
function Topbar() {
  ...
  const { data: profile } = useQuery({
    queryKey: ["me"],
    queryFn: async () => {
      const [p, w] = await Promise.all([api.getProfile(), api.getWallet()]);
      return { email: p?.email, profile: p, wallet: w };
    }
  });
  const initials = (profile?.profile?.full_name ?? profile?.email ?? "?").split(/[@\s]/).filter(Boolean).slice(0, 2).map((s) => s[0]?.toUpperCase()).join("");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 flex h-14 items-center gap-2 border-b border-border bg-background px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarTrigger, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden items-center gap-2 rounded-full border border-border bg-secondary/60 px-3 py-1.5 text-sm sm:flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "h-4 w-4 text-brand" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold", children: [
          "$",
          Number(profile?.wallet?.balance ?? 0).toLocaleString()
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: t("dashboard.topbar.balance") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-4 w-4 text-yellow-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "h-4 w-4" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "rounded-full", title: "Change language", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base leading-none", children: currentLang.flag }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuLabel, { className: "flex items-center gap-2 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Languages, { className: "h-3.5 w-3.5" }),
            " Language"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
          LANGUAGES.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            DropdownMenuItem,
            {
              onClick: () => setLang(l.id),
              className: `flex items-center gap-2 ${lang === l.id ? "font-semibold text-brand" : ""}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base", children: l.flag }),
                l.label,
                lang === l.id && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-brand", children: "✓" })
              ]
            },
            l.id
          ))
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "flex items-center gap-2 rounded-full p-1 hover:bg-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "h-8 w-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-brand text-xs text-white", children: initials || "U" }) }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-56", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuLabel, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: profile?.profile?.full_name ?? "Account" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-normal text-muted-foreground", children: profile?.email })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard/profile", children: "Profile" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard/settings", children: "Settings" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
...
function PageHeader({ title, description, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold sm:text-3xl", children: title }),
