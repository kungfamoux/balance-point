  ...
  head: () => ({
    meta: [
      ...
      { title: "Balancepoint Capital — Professional Market Infrastructure" },
      {
        name: "description",
        content:
          "Access 40,000+ instruments across FX, stocks, crypto, commodities and real estate — trade, hedge and invest from a single account.",
      },
...
function RootComponent() {
  ...
  useEffect(() => {
    // No-op: auth state is managed via localStorage session
  }, [router, queryClient]);
